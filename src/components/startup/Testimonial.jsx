  ...
  return (
    <div className=' bg-black h-[700px] w-full relative flex py-10 justify-center text-white'>
      ...
      <div className=' w-[80%] flex flex-col justify-between'>
         ...
         <div className=' flex flex-col justify-between w-full xl:w-[90%] 2xl:w-[80%] m-auto h-[60%] items-center'>
              <h1 className=' text-4xl lg:text-[60px] xl:text-[70px] font-gilroy-bold text-center'>what people say about us</h1>
