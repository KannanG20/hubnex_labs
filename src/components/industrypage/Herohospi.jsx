       ...
       <div className=' xl:h-[838px] h-screen bg-ind2 bg-cover bg-center w-full relative '>
        ...
        <div className=' w-[80%] flex items-center'>
            <div className=' text-white flex flex-col justify-center items-center lg:items-start gap-10 w-90 max-[820px]:text-center'>
                <span className='  text-[28px] md:text-[50px] lg:text-[70px] font-gilroy-bold leading-tight lg:w-[700px]'>Efficient Logistics for Your Supply Chain</span>
                <p className=' text-[24px] font-gilroy-semi-bold lg:w-[600px]'>Travel, Transportation, Logistics and Hospitality</p>
