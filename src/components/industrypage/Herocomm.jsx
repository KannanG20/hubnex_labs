       ...
       <div className=' xl:h-[838px] h-screen bg-ind1 bg-cover bg-center w-full relative '>
        ...
        <div className=' w-[80%] flex items-center'>
            <div className=' text-white flex flex-col justify-center items-center lg:items-start gap-10 w-90 max-[820px]:text-center'>
                ...
                text-[28px] md:text-[50px] lg:text-[70px] font-gilroy-bold leading-tight lg:w-[700px]

                '>Revolutionizing the way we connect</span>
                <p className=' text-[20px] font-gilroy-semi-bold lg:w-[600px]'>Digitalizing Communication Empowering Businesses to Thrive in the Future</p>
