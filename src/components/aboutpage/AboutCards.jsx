    ...
    <>
      <div className='bg-ablack w-full min-h-screen 2xl:h-[1024px] flex justify-evenly items-center gap-5 flex-col '>
        ...
        <div className='flex flex-wrap justify-center '>
          ...
          <div className=" flex flex-col w-[292px] h-[320px] rounded-lg m-6 p-5 lg:p-8 bg-white items-center font-gilroy-bold  overflow-hidden">
            ...
            <h1 className='text-center mt-[28px] text-grey text-[24px] font-poppins-semibold'>Our Mission</h1>
            <div className='text-center  text-grey text-[16px] font-poppins-regular'>Use the power of technology and our deep understanding of the industry to solve engineering challenges of any nature, scale, or complexity</div>
          ...
          <div className=" flex flex-col w-[292px] h-[320px] rounded-lg m-6 p-5 lg:p-8 bg-white items-center font-gilroy-bold  overflow-hidden">
            ...
            <h1 className='text-center mt-[28px] text-grey text-[24px] font-poppins-semibold '>Our Philosophy</h1>
            <div className='text-center  text-grey text-[16px] text-base font-poppins-regular'>Go above and beyond to bring in new perspectives, relentless energy, and utmost dedication to driving client success</div>
          ...
          <div className=" flex flex-col w-[292px] h-[320px] rounded-lg m-6 p-5 lg:p-8 bg-white items-center font-gilroy-bold  overflow-hidden">
            ...
            <h1 className='text-center mt-[28px] text-grey text-[24px] font-poppins-semibold'>Our Vision</h1>
            <div className='text-center  text-grey text-[16px] text-base font-poppins-regular'>Harness innovation to accelerate digital transformation and drive change & client success</div>
          ...
          <div className=" flex flex-col w-[292px] h-[320px] rounded-lg m-6 p-5 lg:p-8 bg-white items-center font-gilroy-bold  overflow-hidden">
            ...
            <h1 className='text-center mt-[28px] text-grey text-[24px] font-poppins-semibold'>Our Strategy</h1>
            <div className='text-center  text-grey text-[16px] text-base font-poppins-regular'>Leverage next-gen technologies, robust internal frameworks, and defined processes to provide best-in-class services within timelines</div>
          </div>     
        </div>
      </div>
    </>
