            ...
            <div className=' w-[80%] flex justify-between '>
                <div className=' w-full flex flex-col gap-20 text-white   '>
                   <div className=' w-90 flex flex-col gap-10 text-center md:mt-40 '>
                    ...
                    <p className='text-center font-gilroy-medium text-[24px]'>Our values shape the culture of our organization and define who we are. These are at the core of how we work and what we do. We are:</p>
                   </div>
                   ...
                   <div className=' w-full flex flex-col gap-8 lg:flex-row  lg:justify-evenly items-center  '>
                        <div className=' w-[303px] lg:h-[163px] text-center  '>
                            <span className=' text-[22px] font-gilroy-semi-bold'>Your Next-Gen Technology Partner</span>
                        ...
                        <div className='w-[303px] lg:h-[163px] text-center max-[360px]:w-60'>
                            ...
                            <p className='text-sm mt-5 lg:text-[20px] font-gilroy-regular leading-6'>We are, above all else, customer-centric. We are in it for the long run and have an unwavering passion for client success.</p>
                        </div>
                   </div>
                </div>
