  ...
  return (
    ...
    <div className='w-full h-full flex justify-center flex-col items-center relative bg-moon bg-cover bg-no-repeat bg-center'>
        ...
        <div className=' text-white'>
            <div className=' flex flex-col items-center gap-5 mb-16 md:mb-20 lg:mb-36'>
                <div className=' flex flex-col items-center font-gilroy-bold md:font-gilroy-semi-bold text-[18px] md:text-[28px]'>
                    <span>your have an idea?</span>
                    <span>we have a team</span>
                </div>
                <Link to='/service'><button className=' border-none bg-white py-1 lg:py-[10px] md:text-[20px] px-5 rounded-full text-black text-[13px] font-gilroy-semi-bold'>get started </button></Link>
            </div>
        </div>
    </div>
  )
