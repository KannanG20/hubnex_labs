  ...
  return (
    ...
    <ToastContainer/>
      <div className=' flex flex-col sm:flex-row gap-5 sm:gap-0 justify-between w-full items-center'>
        ...
        <Link to='https://hubnex.netlify.app/data-protection' target='_blank' className=' rounded-full bg-sky-400 flex justify-center items-center py-2 px-4 text-white'>Goto page</Link>
        </div>
      </div>
