        ...
        <div className=' w-full h-20 flex flex-col py-5 gap-5'>
          <div className=' w-full flex justify-between'>
            <div className=' w-full h-full justify-start flex gap-2 items-center'>
              ...
              <div className='w-[5%] bg-slate-900 lg:hidden flex justify-end'>
                {menuOpen ? (
                  <CloseRoundedIcon fontSize='large' className='text-white cursor-pointer p-2' onClick={() => setMenuOpen(false)} />
                ) : (
                  <MenuRoundedIcon fontSize='large' className='text-white cursor-pointer p-2' onClick={() => setMenuOpen(true)} />
                )}
              </div>
