        ...
        <div className='w-full h-full flex items-center justify-center'>
            <div className=' text-white w-[85%] flex justify-start h-full  items-center'>
                <div className=' w-90 flex flex-col gap-8 xl:gap-14 lg:mb-[180px] xl:mb-48'>
                    <span className=' text-[50px] lg:text-[70px] font-gilroy-bold leading-tight lg:w-[700px]'>Secure and Reliable Cloud Services</span>
                    <p className=' text-[24px] font-gilroy-semi-bold'>"Powering Your Business with Cloud Confidence"</p>
