        ...
        <div className=' h-full w-full flex justify-center items-center'>
            <div className='w-[90%] flex flex-col gap-10 md:justify-around h-full items-center text-black'>
                <div className='w-full gap-5 flex flex-col items-center justify-center'>
                    <h1 className=' text-white text-[28px] md:text-[50px] xl:text-[70px] text-center font-gilroy-bold'>Our Services</h1>
                ...
                <div className=' card h-auto py-5 lg:py-[35px] lg:h-[345px] w-[414px] px-5 relative rounded-md bg-100 bg-opacity-20   flex flex-col justify-evenly '>
                  ...
                  <div className=' w-full flex flex-col gap-5 '>
                    <p className='   font-gilroy-semi-bold text-[24px] text-white'>Functional Testing</p>
                ...
                <div className=' card h-auto py-5 lg:py-[35px] lg:h-[345px] relative w-[414px] px-5 rounded-md bg-black-100 bg-opacity-20    flex flex-col justify-evenly '>
                  ...
                  <div className=' w-full flex flex-col gap-5'>
                    <p className='  font-gilroy-semi-bold text-[24px] text-white'>Usability Testing</p>
                ...
                <div className='card h-auto py-5 lg:py-[35px] lg:h-[345px] relative w-[414px] px-5 rounded-md bg-black-100 bg-opacity-20    flex flex-col justify-evenly '>
                  ...
                  <div className=' w-full flex flex-col gap-5'>
                    <span className='  font-gilroy-semi-bold text-[24px] text-white'>Performance Testing</span>
                ...
                <div className='card h-auto py-5 lg:py-[35px] lg:h-[345px] relative w-[414px] px-5 rounded-md bg-black-100 bg-opacity-20    flex flex-col justify-evenly '>
                  ...
                  <div className=' w-full flex flex-col gap-5'>
                    <p className='  font-gilroy-semi-bold text-[24px] text-white'>Security Testing</p>
                ...
                <div className='card h-auto py-5 lg:py-[35px] lg:h-[345px] relative w-[414px] px-5 rounded-md bg-black-100 bg-opacity-20    flex flex-col justify-evenly '>
                  ...
                  <div className=' w-full flex flex-col gap-5'>
                    <p className='  font-gilroy-semi-bold text-[24px] text-white'>Compatibility Testing</p>
                ...
                <div className='card h-auto py-5 lg:py-[35px] lg:h-[345px] relative w-[414px] px-5 rounded-md bg-black-100 bg-opacity-20    flex flex-col justify-evenly '>
                  ...
                  <div className=' w-full flex flex-col gap-5'>
                    <p className='  font-gilroy-semi-bold text-[24px] text-white'>Web & Mobile App Testing</p>
                ...
                <div className='card h-auto py-5 lg:py-[35px] lg:h-[345px] relative w-[414px] px-5 rounded-md bg-black-100 bg-opacity-20    flex flex-col justify-evenly '>
                  ...
                  <div className=' w-full flex flex-col gap-5'>
                    <p className='  font-gilroy-semi-bold text-[24px] text-white'>Automated Testing</p>
                ...
                <div className='card h-auto py-5 lg:py-[35px] lg:h-[345px] relative w-[414px] px-5 rounded-md bg-black-100 bg-opacity-20    flex flex-col justify-evenly '>
                  ...
                  <div className=' w-full flex flex-col gap-5'>
                    <p className='  font-gilroy-semi-bold text-[24px] text-white'>Manual Testing</p>
                ...
                <div className=' h-auto py-5 lg:py-[35px] lg:h-[345px] w-[414px] relative px-5 rounded-md bg-black-100 bg-opacity-20 card flex flex-col justify-evenly '>
                  ...
                  <div className=' w-full flex flex-col gap-5'>
                    <p className='  font-gilroy-semi-bold text-[24px] text-white'>API Testing</p>
