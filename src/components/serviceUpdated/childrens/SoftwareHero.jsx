        ...
        <div className='w-full h-full flex items-center justify-center'>
            <div className=' text-white w-[85%] flex justify-start h-full  items-center'>
                <div className=' w-90 flex flex-col gap-8 xl:gap-14 lg:mb-[180px] xl:mb-48'>
                    <span className=' text-[50px] lg:text-[70px] font-gilroy-bold leading-tight lg:w-[720px]'>Ensuring High-Quality Software Delivery</span>
                    <p className=' text-[24px] font-gilroy-semi-bold'>"Maximizing Your Software Potential with Advanced Testing Solutions"</p>
