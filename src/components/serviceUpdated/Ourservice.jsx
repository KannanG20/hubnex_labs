            ...
            <div className='w-[90%] flex flex-col gap-10 md:justify-around h-full items-center text-black'>
                ...
                <div className=' card h-auto py-5 lg:py-[35px] lg:h-[345px] w-[414px] px-5 relative rounded-md bg-100 bg-opacity-20   flex flex-col justify-evenly '>
                  ...
                  <div className=' w-full flex flex-col gap-5 '>
                    <p className='   interFont text-[24px] text-white'>Custom Web Development</p>
                ...
                <div className=' card h-auto py-5 lg:py-[35px] lg:h-[345px] relative w-[414px] px-5 rounded-md bg-black-100 bg-opacity-20    flex flex-col justify-evenly '>
                  ...
                  <div className=' w-full flex flex-col gap-5'>
                    <p className='  interFont text-[24px] text-white'>Software Consulting</p>
                ...
                <div className='card h-auto py-5 lg:py-[35px] lg:h-[345px] relative w-[414px] px-5 rounded-md bg-black-100 bg-opacity-20    flex flex-col justify-evenly '>
                  ...
                  <div className=' w-full flex flex-col gap-5'>
                    <span className='  interFont text-[24px] text-white'>Implementation & Deployment</span>
                ...
                <div className='card h-auto py-5 lg:py-[35px] lg:h-[345px] relative w-[414px] px-5 rounded-md bg-black-100 bg-opacity-20    flex flex-col justify-evenly '>
                  ...
                  <div className=' w-full flex flex-col gap-5'>
                    <p className='  interFont text-[24px] text-white'>Maintenance & Management</p>
                ...
                <div className='card h-auto py-5 lg:py-[35px] lg:h-[345px] relative w-[414px] px-5 rounded-md bg-black-100 bg-opacity-20    flex flex-col justify-evenly '>
                  ...
                  <div className=' w-full flex flex-col gap-5'>
                    <p className='  interFont text-[24px] text-white'>Mobile Web Development</p>
                ...
                <div className='card h-auto py-5 lg:py-[35px] lg:h-[345px] relative w-[414px] px-5 rounded-md bg-black-100 bg-opacity-20    flex flex-col justify-evenly '>
                  ...
                  <div className=' w-full flex flex-col gap-5'>
                    <p className='  interFont text-[24px] text-white'>Custom Application Development</p>
                ...
                <div className='card h-auto py-5 lg:py-[35px] lg:h-[345px] relative w-[414px] px-5 rounded-md bg-black-100 bg-opacity-20    flex flex-col justify-evenly '>
                  ...
                  <div className=' w-full flex flex-col gap-5'>
                    <p className='  interFont text-[24px] text-white'>API Development & Integration</p>
                ...
                <div className='card h-auto py-5 lg:py-[35px] lg:h-[345px] relative w-[414px] px-5 rounded-md bg-black-100 bg-opacity-20    flex flex-col justify-evenly '>
                  ...
                  <div className=' w-full flex flex-col gap-5'>
                    <p className='  interFont text-[24px] text-white'>Custom UX/UI Design</p>
                ...
                <div className=' h-auto py-5 lg:py-[35px] lg:h-[345px] w-[414px] relative px-5 rounded-md bg-black-100 bg-opacity-20 card flex flex-col justify-evenly '>
                  ...
                  <div className=' w-full flex flex-col gap-5'>
                    <p className='  interFont text-[24px] text-white'>System Integration</p>
